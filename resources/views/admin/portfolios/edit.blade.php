    ...
    <div class="card-body">
        <form action="{{ route("admin.portfolios.update", [$portfolio->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                ...
                <textarea id="description" name="description" class="form-control ">{{ old('description', isset($portfolio) ? $portfolio->description : '') }}</textarea>
            ...
            <div class="form-group {{ $errors->has('logo') ? 'has-error' : '' }}">
                <label for="logo">{{ trans('cruds.portfolio.fields.logo') }}</label>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.portfolio.fields.logo_helper') }}
                </p>
            </div>
            <div>
...
<script>
    ...
    init: function () {
@if(isset($portfolio) && $portfolio->logo)
      var file = {!! json_encode($portfolio->logo) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, '{{ $portfolio->logo->getUrl('thumb') }}')
