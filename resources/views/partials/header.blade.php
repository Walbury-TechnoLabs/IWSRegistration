        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand logo_1" href="https://muniversiti.org"> <img src="{{ asset('img/single_page_logo.png') }}" alt="logo"> </a>
                    <a class="navbar-brand logo_2" href="https://muniversiti.org"> <img src="{{ asset('img/logo.png') }}" alt="logo"> </a>
                    ...
                    <div class="collapse navbar-collapse main-menu-item justify-content-end"
                        ...
                        <ul class="navbar-nav align-items-center">
                            <li class="nav-item">
                                <a class="nav-link" href="https://muniversiti.org2">Home</a>
                            </li>
                            <!-- <li class="nav-item">
